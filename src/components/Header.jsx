...
const Header = ({setModalView}) => {
    return (
        <section id="header" className="flex justify-between items-center px-10 py-4 bg-slate-100">
            <div className="flex items-center ml-5">
                <IconContext.Provider value={{size: "75px"}}>
                    <MdOutlineMovieCreation />
                </IconContext.Provider>
                <h3 className="ml-4 font-bold text-3xl font-sen"> Browse Through All of Your Favorite Movies! </h3>
            </div>
