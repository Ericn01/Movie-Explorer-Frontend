...
const HomeView = ({movieData, setParentMovieMatches}) => {
    ...
    return (
        <section className="flex justify-center items-center h-screen bg-[url('src/images/hero-img.jpg')] bg-opacity-50">
                ...
                <div className="flex-auto my-7"> 
                    <div className='relative'>
                        <div className="absolute top-2 left-2">
                            <img src="src/images/search.png" width={"24px"} draggable={false}/>
                        </div>
